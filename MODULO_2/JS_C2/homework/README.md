...
1. Escribe un programa que almacene la cadena de caracteres contraseña en una variable. Tu programa debe preguntar por medio de un ´prompt´ al usuario por la contraseña e imprima por pantalla  el mensaje "Inicio de sesion exitoso" solo si la contraseña introducida por el usuario coincide con la guardada en la variable.
